...
![Detection example](assets/detect_ex.JPG)
...
The dataset for this project has been  acquired from the Kaggle dataset [PCB Defects] (https://www.kaggle.com/datasets/akhatova/pcb-defects)
